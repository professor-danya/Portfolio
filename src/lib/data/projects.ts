...
export const projects: Project[] = [
  {
    id: "ai-workflow-prototype",
    title: "AI Workflow Prototype",
    category: "Automation systems",
    status: "Prototype",
    workType: "Engineering experiment",
    summary:
      "An engineering prototype exploring how incoming business requests can become structured, reviewable actions.",
    problem:
  ...
  },
  {
    ...
    title: "Telegram Assistant Experiment",
    category: "Conversational systems",
    status: "Experiment",
    workType: "Engineering experiment",
    summary:
      "An experiment in combining structured Telegram commands with contextual AI responses.",
    problem:
  ...
  },
  {
    ...
    title: "Structured Data Parser",
    category: "Data infrastructure",
    status: "Prototype",
    workType: "Engineering experiment",
    summary:
      "A parser prototype for converting inconsistent source files into validated, structured records.",
    problem:
